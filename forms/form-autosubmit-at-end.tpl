...
function renderButton() {
    if(currFormPosition >= (formStructure.length - 1)) {
        $(".nextQuestion").html('<img src="../libs/dynicons/?img=go-next.svg&amp;w=22" alt="Submit" /> Submit');
    } else {
        $(".nextQuestion").html('<img src="../libs/dynicons/?img=go-next.svg&amp;w=22" alt="Next" /> Next Question');
    }
}
    ...
    if(currFormPosition < formStructure.length) {
        ...
        $.ajax({
            ...
            success: function(response) {
                $("#bodyarea").html(`<h1 style="text-align: center;">Thank you for completing this ${requestLabel}.</h1>
					<p style="text-align: center;"><a href="./">Click here if you are not automatically redirected to the main page</a></p>`);
                setTimeout(function() {
                	window.location = './';
                }, 3000);
            }});
