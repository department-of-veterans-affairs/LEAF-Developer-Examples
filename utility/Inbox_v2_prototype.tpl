...
<script>
    ...
    function buildDepInbox(res, categoryIDs, categoryName, recordIDs, site) {
        ...
        $(`#siteFormContainer${hash}`).append(`<div id="depContainer${hash}_${depID}" class="depContainer"><div id="depLabel${hash}_${depID}" class="depInbox" style="padding: 8px">
    ...
    function loadInboxData(site, offset) {
        ...
        query.setExtraParams(
            '&x-filterData=recordID,categoryIDs,categoryNames,date,title,service,submitted,stepID,blockingStepID,lastStatus,stepTitle,action_history.time' +
            nonAdminParam);
